...
|        File        |        Description       |
| :----------------- | :----------------------- |
| [Python.py](/assets/Code/AI%20adoption/python.py) | Full analysiis script |
| [Dataset.csv](/assets/Code/AI%20adoption/corporate_ai_adoption_dataset.csv) | Source dataset |
